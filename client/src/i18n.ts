...
export interface Strings {
  ...
  // The public preview — /map and (later) the landing page. See the design
  // note in docs/ for what is and is not shown to a stranger with no account.
  previewBadge: string;
  previewBannerBody: string;
  previewSignIn: string;
  tileMeasured: string;
  tilePredicted: string;
  tileNotYetMeasured: string;
  tileUpdated: string;
  ...
  // Landing page (/) — see site/Landing.tsx.
  landingViewMap: string;
  landingMethodCta: string;
  landingConceptBody: string;
  ...
  landingStep4: string;
  landingStep5: string;
  landingStatusTitle: string;
  landingStatusBackend: string;
  landingStatusAndroid: string;
  landingStatusMl: string;
  landingStatusWeb: string;
}
...
const en: Strings = {
  ...
  previewBannerBody:
    "Combined-network coverage, at hexagon level — the same map whether or not you sign in. Per-network detail, mast positions and the ranked investment list are on the separate operator and government portal.",
  previewSignIn: "Sign in",
  tileMeasured: "Measured",
  tilePredicted: "Predicted",
  tileNotYetMeasured: "Not yet measured",
  tileUpdated: "Map data updated",
  ...
  usersCreditTitle: "What they did — e.g. Project lead",
  ...
  landingViewMap: "View the live map",
  landingMethodCta: "How we measure",
  landingConceptBody:
    "Measuring the signal and using the internet are two different things. A phone's modem keeps scanning for base stations whether or not any data flows, and GPS needs no network at all. So the app records a reading in a place with no service, holds it, and uploads when the user returns to coverage. Places with no signal at all become the most valuable data on this map, rather than blank gaps on it.",
  landingHowTitle: "How the system works",
  landingStep1: "A phone measures",
  landingStep2: "Signed, then checked",
  landingStep3: "Combined into hexagons",
  landingStep4: "Predicted and ranked",
  landingStep5: "Shown on the map",
  landingStatusTitle: "The project's real status",
  landingStatusBackend: "Backend — working, 75 tests passing",
  landingStatusAndroid: "Android app — builds; not yet run on a handset",
  landingStatusMl: "Coverage prediction (AI) — not started",
  landingStatusWeb: "Web map — working",
};
...
const lo: Strings = {
  ...
  previewBadge: "ຕົວຢ່າງສາທາລະນະ",
  previewBannerBody:
    "ຂໍ້ມູນລວມທຸກເຄືອຂ່າຍ ໃນລະດັບຫົກຫຼ່ຽມ — ແຜນທີ່ດຽວກັນບໍ່ວ່າຈະເຂົ້າສູ່ລະບົບຫຼືບໍ່. ລາຍລະອຽດແຕ່ລະເຄືອຂ່າຍ, ຕຳແໜ່ງເສົາສັນຍານ ແລະ ບັນຊີພື້ນທີ່ຄວນລົງທຶນ ຢູ່ໃນລະບົບແຍກສຳລັບຜູ້ໃຫ້ບໍລິການ ແລະ ພາກລັດ.",
  previewSignIn: "ເຂົ້າສູ່ລະບົບ",
  tileMeasured: "ວັດແທກແລ້ວ",
  tilePredicted: "ຄາດຄະເນ",
  tileNotYetMeasured: "ຍັງບໍ່ໄດ້ວັດແທກ",
  tileUpdated: "ອັບເດດຂໍ້ມູນແຜນທີ່",
  ...
  usersCreditTitle: "ເຮັດຫຍັງ — ຕົວຢ່າງ: ຫົວໜ້າໂຄງການ",
  ...
  landingViewMap: "ເບິ່ງແຜນທີ່ສົດ",
  landingMethodCta: "ວິທີການວັດແທກ",
  landingConceptBody:
    "ການ 'ວັດແທກສັນຍານ' ກັບການ 'ໃຊ້ອິນເຕີເນັດ' ເປັນຄົນລະເລື່ອງກັນ. ໂມເດັມຂອງໂທລະສັບຍັງສະແກນຫາເສົາສັນຍານຢູ່ຕະຫຼອດ ບໍ່ວ່າຈະມີການສົ່ງຂໍ້ມູນຫຼືບໍ່ ແລະ GPS ກໍ່ບໍ່ຕ້ອງໃຊ້ອິນເຕີເນັດເລີຍ. ແອັບຈຶ່ງບັນທຶກຄ່າໄດ້ໃນບ່ອນທີ່ບໍ່ມີສັນຍານ ເກັບໄວ້ ແລ້ວສົ່ງເມື່ອກັບເຂົ້າສູ່ພື້ນທີ່ມີສັນຍານ. ບ່ອນທີ່ 'ບໍ່ມີສັນຍານເລີຍ' ຈຶ່ງກາຍເປັນຂໍ້ມູນທີ່ມີຄ່າທີ່ສຸດຂອງແຜນທີ່ນີ້ ແທນທີ່ຈະເປັນຊ່ອງຫວ່າງເທິງແຜນທີ່.",
  landingHowTitle: "ລະບົບເຮັດວຽກແນວໃດ",
  landingStep1: "ໂທລະສັບວັດແທກ",
  landingStep2: "ລົງລາຍເຊັນ ແລະ ກວດສອບ",
  landingStep3: "ລວມເປັນຫົກຫຼ່ຽມ",
  landingStep4: "ຄາດຄະເນ ແລະ ຈັດອັນດັບ",
  landingStep5: "ສະແດງເທິງແຜນທີ່",
  landingStatusTitle: "ສະຖານະຕົວຈິງຂອງໂຄງການ",
  landingStatusBackend: "Backend — ໃຊ້ງານໄດ້ຈິງ, ຜ່ານ 75 ການທົດສອບ",
  landingStatusAndroid: "ແອັບ Android — ບິວໄດ້; ຍັງບໍ່ໄດ້ລົງເຄື່ອງຈິງ",
  landingStatusMl: "ການຄາດຄະເນການຄອບຄຸມ (AI) — ຍັງບໍ່ໄດ້ເລີ່ມ",
  landingStatusWeb: "ແຜນທີ່ເວັບ — ໃຊ້ງານໄດ້ຈິງ",
};
